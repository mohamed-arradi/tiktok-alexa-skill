                    ...
                    new api.TikTokTrendingService().fetchTrends(function(trends) {
                        if (trends !== undefined &&
                            ...
                            let backgroundImage = new Alexa.ImageHelper()
                                .withDescription(trend.desc !== undefined ? trend.desc : TITLE)
                                .addImageInstance(video.cover !== undefined ? video.cover : BACKGROUND_IMAGE_URL)
                                .getImage();

                            let primaryText = new Alexa.RichTextContentHelper()
                                .withPrimaryText(trend.desc !== undefined ? trend.desc : TITLE)
                                .getTextContent();
...
function welcomeResponse(handlerInput) {
    ...
    let welcomeText = "Welcome to TikTok Fan, you can ask me to show you a funny video. Just tell me when !"
    ...
    if (hasDisplay(handlerInput.requestEnvelope)) {
        if (supportsAPL(handlerInput.requestEnvelope)) {
            ...
            return handlerInput.responseBuilder
                ...
                .reprompt("Don't forget to ask me if you need to see a video.")
                .addDirective({
